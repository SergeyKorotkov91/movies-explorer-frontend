      ...
      <div className="popup__container">
        ...
        <div className="popup__menu">
          <div className="popup__navigation">
            <NavLink className="popup__navlink" to="/" onClick={onClose}>
              Главная
            </NavLink>
            <NavLink className="popup__navlink" to="/movies" onClick={onClose}>
              Фильмы
            </NavLink>
            <NavLink className="popup__navlink" to="/saved-movies" onClick={onClose}>
              Сохранённые фильмы
            </NavLink>
          </div>
